 ...
 */
class Module_category_assignment extends Module {
	...
	public function info()
	{
		return array(
			'name' => array(
				'en' => 'Category Assignment',
				'ar' => 'المدوّنة',
				'br' => 'Category Assignment',
				'pt' => 'Category Assignment',
				'el' => 'Ιστολόγιο',
				'he' => 'בלוג',
				'id' => 'Category Assignment',
				'lt' => 'Category Assignment',
				'pl' => 'Category Assignment',
				'ru' => 'Category Assignment',
				'zh' => '文章',
				'hu' => 'Category Assignment',
				'fi' => 'Category Assignment',
				'th' => 'บล็อก',
            	'se' => 'Category Assignment',
			),
			'description' => array(
				'en' => 'Review and assign category to purchasing officer',
			...
			'roles' => array(
				'put_live', 'edit_live', 'delete_live'
			  	    ...
			  	    'shortcuts' => array(
						array(
					 	   'name' => 'cat_assign:new_assign_label',
						    'uri' => 'admin/category_assignment/assign',
						    'class' => 'add'
						),
					),
